# bswap.spec
#
# Copyright (c) 2005 Meihui Fan mhfan@ustc.edu
#
%define name bswap
...
#Icon:
#URL:
#Packager: Meihui Fan mhfan@ustc.edu
...
Summary: Utility for bytes swapping, especially for endianess(little-/big-) converting.

%description
Utility for bytes swapping, especially for endianess(little-/big-) converting.
bswap.spec.  Generated from bswap.spec.in by configure.
Please edit bswap.spec.in to add several more lines of description
